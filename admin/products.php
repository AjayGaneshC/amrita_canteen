...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="number" min="0" max="999" required placeholder="enter product quantity" name="quantity" class="box">
...
<section class="show-products" style="padding-top: 0;">
   ...
   <div class="box">
      ...
      <div class="name">Remaining: <?= $fetch_products['quantity']; ?></div>
      <div class="flex-btn">
